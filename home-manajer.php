...
if($_SESSION['hak_akses']!="KADEP_SDM"){
    die("<b>Oops!</b> Access Failed.
		<p>Anda Bukan KADEP_SDM.</p>
		<button type='button' onclick=location.href='index.php'>Back</button>");
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Aplikasi Pengajuan Monitoring Online</title>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs">Aplikasi Pengajuan Monitoring Online</span> &nbsp;<i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu">
	...
	<aside class="main-sidebar">
		<section class="sidebar">
			<ul class="sidebar-menu">
				...
				<li class="treeview"><a href="home-manajer.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></i></a></li>
				<li class="treeview"><a href="home-manajer.php?page=history-Drm"><i class="fa fa-exchange"></i> <span>History Drm Pegawai</span></a></li>
				<li class="treeview"><a href="home-manajer.php?page=laporan-bulanan"><i class="fa fa-exchange"></i> <span>Laporan Drm Pegawai</span></a></li>
				<li class="treeview"><a href="home-manajer.php?page=ubah-passward-kadep"><i class="pe-7s-note2"></i><span>Ubah Password</span></i></a></li>
			</ul>
		</section>
	</aside>
		...
		<section class="content">
			<?php
				...
				switch ($page) {
					...
					case 'history-Drm': include "pages/view/history-Drm.php"; break;
					case 'ubah-passward-kadep': include "pages/transaksi/ubahpassword-kadep.php"; break;
					case 'update-passward-kadep': include "pages/transaksi/updatepassword-kadep.php"; break;
					case 'laporan-bulanan': include "pages/transaksi/laporan.php"; break;
