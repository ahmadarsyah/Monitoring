		...
		echo "<div class='register-logo'><b>Oops!</b> Data Tidak Lengkap.</div>
            ...
            <div class='register-box-body control-label col-sm-offset-4 col-sm-4'>
					...
					<div class='row'>
						...
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-hrd.php?page=ubah-passward-hrd' class='btn btn-block btn-warning'>Back</button>
						</div>
					</div>
				</div>
			</div>";
...
if ($query){
            ...
            <div class='register-box-body control-label col-sm-offset-4 col-sm-4'>
					...
					<div class='row'>
						<div class='col-xs-8'></div>
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-hrd.php?page=ubah-passward-hrd'class='btn btn-block btn-warning'>Back</button>						</div>
					</div>
				</div>";
}
?>
